...
- Install dep: `npm --prefix frontend install embla-carousel-react`, then upgrade to latest with
...
- Frontend unit: `npm --prefix frontend test -- MoneyFlowSankey` and carousel/adapter tests.
