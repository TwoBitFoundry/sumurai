...
5. [Release Please](https://github.com/googleapis/release-please) opens or updates a release PR on `main`; merging that PR applies version bumps and `CHANGELOG.md`, creates the git tag and GitHub Release.
