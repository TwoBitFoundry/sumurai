...
describe('GlassCard', () => {
  describe('variants', () => {
    ...
    it('renders accent variant correctly', () => {
      const { container } = render(<GlassCard variant="accent">Content</GlassCard>);
      const card = container.firstChild as HTMLElement;
      expect(card?.className).toMatchSnapshot();
    });
  });
  ...
  describe('rounded', () => {
    it('renders default rounded correctly', () => {
      const { container } = render(<GlassCard rounded="default">Content</GlassCard>);
      const card = container.firstChild as HTMLElement;
      expect(card?.className).toMatchSnapshot();
    });
  ...
  describe('withInnerEffects', () => {
    ...
    it('renders without inner effects when disabled', () => {
      const { container } = render(<GlassCard withInnerEffects={false}>Content</GlassCard>);
      const innerEffects = container.querySelector('.pointer-events-none');
  ...
  describe('custom className', () => {
    ...
    it('applies className to inner content wrapper', () => {
      const { container } = render(<GlassCard className="custom-content">Content</GlassCard>);
