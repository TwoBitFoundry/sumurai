...
#[test]
fn given_missing_cookie_name_when_from_env_provider_then_defaults_to_auth_token() {
    let mut env = MockEnvironment::new();
    env.set("TELLER_ENV", "development");
    env.set("AUTH_COOKIE_SECURE", "true");
    env.set("AUTH_COOKIE_SAME_SITE", "Strict");
...
#[test]
fn given_invalid_cookie_secure_when_from_env_provider_then_returns_error() {
    let mut env = MockEnvironment::new();
    env.set("TELLER_ENV", "development");
...
#[test]
fn given_invalid_cookie_same_site_when_from_env_provider_then_returns_error() {
    let mut env = MockEnvironment::new();
    env.set("TELLER_ENV", "development");
    env.set("AUTH_COOKIE_SECURE", "true");
