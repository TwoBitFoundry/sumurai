...
#[openapi(
    ...
    paths(
        ...
        crate::get_authenticated_billing_status,
        crate::create_billing_checkout,
        crate::redeem_trial_code,
        crate::create_billing_payment_method,
        crate::create_billing_portal_session,
        crate::handle_paddle_billing_webhook,
