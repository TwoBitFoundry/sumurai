...
colors:
  ...
  chart-light-1: "{colors.brand-sky}"
  chart-light-2: "{colors.brand-emerald}"
  chart-light-3: "{colors.brand-amber}"
  chart-light-4: "{colors.brand-rose}"
  chart-light-5: "{colors.brand-violet}"
  chart-light-6: "#059669"
  chart-dark-1: "{colors.brand-sky-dark}"
  chart-dark-2: "{colors.brand-emerald-dark}"
  chart-dark-3: "{colors.brand-amber-dark}"
  chart-dark-4: "{colors.brand-rose-dark}"
  chart-dark-5: "{colors.brand-violet-dark}"
  chart-dark-6: "{colors.brand-emerald}"
  semantic-light-cash: "{colors.brand-emerald}"
  semantic-light-investments: "{colors.brand-cyan}"
  semantic-light-credit: "#fb7185"
  semantic-light-loan: "{colors.brand-amber}"
  semantic-light-net-worth: "{colors.brand-violet}"
  semantic-dark-cash: "{colors.brand-emerald-dark}"
  semantic-dark-investments: "{colors.brand-cyan-dark}"
  semantic-dark-credit: "#fb7185"
  semantic-dark-loan: "{colors.brand-amber-dark}"
  semantic-dark-net-worth: "{colors.brand-violet-dark}"
  text-primary: "#0f172a"
  ...
  text-accent-dark: "{colors.brand-sky-dark}"
  text-danger: "#dc2626"
  ...
  border-focus-active: "{colors.brand-sky-dark}"
  border-focus-active-dark: "{colors.brand-sky}"
  border-hover-accent: "#93c5fd"
  border-hover-accent-dark: "{colors.brand-sky-dark}"
  border-danger: "#fca5a5"
  border-danger-dark: "{colors.brand-rose-dark}"
  status-info-surface: "#e0f2fe"
  status-info-surface-dark: "#082f49"
  status-info-border: "#bae6fd"
  status-info-border-dark: "{colors.brand-sky-dark}"
  ...
  status-info-icon: "{colors.brand-sky}"
  status-info-icon-dark: "{colors.brand-sky-dark}"
  status-success-surface: "#ecfdf5"
  status-success-surface-dark: "#065f46"
  status-success-border: "#a7f3d0"
  status-success-border-dark: "{colors.brand-emerald-dark}"
  ...
  status-success-icon: "{colors.brand-emerald}"
  status-success-icon-dark: "{colors.brand-emerald-dark}"
  ...
  status-danger-border-dark: "{colors.brand-rose-dark}"
...
## Overview
Sumurai stays dark-first, glassy, and cyan/violet forward. This file is the visual contract, not a recipe catalog.
