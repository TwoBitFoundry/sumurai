...
export default function BudgetsPage() {
  ...
  const heroStats = (
    <div className="space-y-3">
      ...
      <div className={cn('group', 'relative', 'overflow-hidden', 'rounded-2xl', 'border-2', 'border-slate-200', 'bg-white/80', 'p-5', 'text-slate-700', 'shadow-[0_18px_48px_-36px_rgba(15,23,42,0.55)]', 'transition-all', 'duration-300', 'hover:-translate-y-[2px]', 'hover:border-slate-300', 'dark:border-slate-700', 'dark:bg-[#111a2f]/70', 'dark:text-slate-200', 'dark:hover:border-slate-600')}>
                <div className={cn('pointer-events-none', 'absolute', 'inset-0', 'rounded-2xl', 'bg-gradient-to-br', 'from-slate-200/40', 'via-slate-100/20', 'to-transparent', 'opacity-0', 'transition-opacity', 'duration-300', 'group-hover:opacity-100', 'dark:from-slate-700/40', 'dark:via-slate-800/20')} />
                <div className={cn('relative', 'z-10', 'flex', 'items-center', 'justify-between', 'gap-4')}>
                  <div>
                    <div className={cn('text-[0.65rem]', 'font-semibold', 'uppercase', 'tracking-[0.24em]', 'text-slate-500', 'transition-colors', 'duration-500', 'dark:text-slate-400')}>Total Planned</div>
                    <div className={cn('mt-1', 'text-2xl', 'font-semibold', 'text-slate-900', 'transition-colors', 'duration-500', 'dark:text-white')}>{fmtUSD(stats.totalBudgeted)}</div>
                  </div>
                  <div className="text-right">
                    <div className={cn('text-[0.65rem]', 'font-semibold', 'uppercase', 'tracking-[0.24em]', 'text-slate-500', 'transition-colors', 'duration-500', 'dark:text-slate-400')}>Total Spent</div>
                ...
                <div className={cn('relative', 'z-10', 'mt-4', 'space-y-2.5')}>
                  ...
                  <div className={cn('flex', 'items-center', 'justify-between', 'text-[0.75rem]', 'text-slate-500', 'transition-colors', 'duration-300', 'dark:text-slate-400')}>
                    <span className={cn('font-medium', 'tracking-wide')}>{(utilization * 100).toFixed(0)}% used</span>
            ...
            <>
              <div className={cn('flex', 'flex-wrap', 'items-center', 'justify-between', 'gap-3', 'px-6', 'py-4')}>
                <div className={cn('flex', 'items-center', 'gap-3')}>
                  ...
                  <div className={cn('text-xs', 'font-semibold', 'uppercase', 'tracking-[0.2em]', 'text-slate-600', 'transition-colors', 'duration-500', 'dark:text-slate-300')}>
                    {monthLabel}
                  </div>
                </div>
                <div className={cn('flex', 'items-center', 'gap-3')}>
                  <div className={cn('inline-flex', 'items-center', 'gap-1', 'text-xs', 'font-medium', 'text-slate-500', 'transition-colors', 'duration-500', 'dark:text-slate-400')}>
                    {budgetsLoading && (
                      <>
