...
export const onboardingTokenRecipes = {
  ...
  iconGlow:
    'absolute inset-[20%] rounded-full bg-[var(--color-effect-accent-hover)] opacity-30 blur-[6px] dark:bg-[var(--color-effect-glass-shadow-dark)] dark:opacity-20',
  providerIconGlow:
    'absolute inset-[18%] rounded-full bg-[var(--color-effect-accent-hover)] opacity-35 blur-[6px] dark:bg-[var(--color-effect-glass-shadow-dark)] dark:opacity-20',
  providerConnect: {
