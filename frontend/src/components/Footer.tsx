        ...
        <div className={cn('flex', 'flex-col', 'md:flex-row', 'md:items-start', 'md:justify-between', 'gap-6', 'mb-6')}>
          ...
          <div className={cn('flex', 'flex-col', 'md:flex-row', 'w-full', 'md:w-auto', 'gap-2', 'md:gap-3')}>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className={cn('px-4', 'py-2', 'text-sm', 'font-medium', 'rounded-lg', 'bg-amber-500/80', 'backdrop-blur-sm', 'text-white', 'hover:bg-amber-600/80', 'dark:bg-amber-600/80', 'dark:hover:bg-amber-700/80', 'flex', 'items-center', 'justify-center', 'gap-2', 'transition-colors', 'border', 'border-amber-400/30', 'dark:border-amber-500/30', 'whitespace-nowrap')}
            >
              <img
