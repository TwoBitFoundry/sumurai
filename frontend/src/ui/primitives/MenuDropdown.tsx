...
export const menuDropdownRecipes = {
  ...
  item: [
    ...
    'hover:ring-[var(--color-border-hover-accent)]',
    'active:ring-[var(--color-border-hover-accent)]',
    ...
    'dark:text-slate-300',
    'dark:hover:ring-[var(--color-border-hover-accent)]',
    'dark:active:ring-[var(--color-border-hover-accent)]',
    'dark:focus-visible:ring-2',
    'dark:focus-visible:ring-[var(--color-border-focus-active)]',
