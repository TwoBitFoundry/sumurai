...
function BudgetCard({
  ...
  const editPlannedAmount = Number.isFinite(parsedDraft) && draft !== '' ? parsedDraft : b.amount;
      ...
      >
        ...
        <div className={cn('relative', 'z-10', 'mt-3', 'flex-1', 'lg:mt-2')}>
          <div className={budgetStatGridClass}>
            ...
            <div
              className={cn(budgetAmountClass, uiTextRecipes.primary, 'self-center', 'text-right')}
            >
