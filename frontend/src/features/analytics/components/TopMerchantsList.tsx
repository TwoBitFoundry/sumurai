    ...
    <div className="space-y-3">
      {merchants.length > 0 ? (
        merchants.slice(0, 5).map((merchant, index) => (
          <div key={merchant.name + index} className="flex items-center justify-between p-3 rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50 transition-all duration-300 hover:border-[#93c5fd] dark:hover:border-[#38bdf8]">
